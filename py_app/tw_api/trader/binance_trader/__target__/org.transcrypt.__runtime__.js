// Transcrypt'ed from Python, 2023-10-12 17:26:26
...
export function __get__(aThis, func, quotedFuncName) {
  if (aThis) {
    if (
      aThis.hasOwnProperty("__class__") ||
      typeof aThis == "string" ||
      aThis instanceof String
    ) {
      if (quotedFuncName) {
      ...
      return function () {
        ...
        return func.apply(
          null,
          [aThis.__proxy__ ? aThis.__proxy__ : aThis].concat(args),
        );
      };
    } else {
      return func;
...
export var object = {
  ...
  __new__: function (args) {
    var instance = Object.create(this, {
      __class__: { value: this, enumerable: true },
    });
...
export function __specialattrib__(attrib) {
  return (
    (attrib.startswith("__") && attrib.endswith("__")) ||
    attrib == "constructor" ||
    attrib.startswith("py_")
  );
}
...
export function __t__(target) {
  return target === undefined || target === null
    ? false
    : ["boolean", "number"].indexOf(typeof target) >= 0
      ? target
      : target.__bool__ instanceof Function
        ? target.__bool__()
          ? target
          : false
        : target.__len__ instanceof Function
          ? target.__len__() !== 0
            ? target
            : false
...
export function float(any) {
  if (any == "inf") {
    ...
    if (any === false) {
      ...
      throw ValueError(
        "could not convert string to float: '" + str(any) + "'",
        new Error(),
      );
    }
  } else {
...
export function isinstance(anObject, classinfo) {
  try {
    return "__class__" in anObject
      ? issubclass(anObject.__class__, classinfo)
      : issubclass(py_typeof(anObject), classinfo);
  } catch (exception) {
...
export function zip() {
  ...
  var shortest =
    args.length == 0
      ? []
      : args.reduce(function (array0, array1) {
...
Array.prototype.__repr__ = function () {
  ...
  let result =
    !this.__class__ || this.__class__ == list
      ? "["
...
String.prototype.__repr__ = function () {
  return (this.indexOf("'") == -1 ? "'" + this + "'" : '"' + this + '"')
    .py_replace("\t", "\\t")
    .py_replace("\n", "\\n");
};
...
String.prototype.rsplit = function (sep, maxsplit) {
  ...
  if (maxsplit == undefined || maxsplit == -1) {
    ...
    if (maxsplit < result.length) {
      ...
      return [result.slice(0, maxrsplit).join(sep)].concat(
        result.slice(maxrsplit),
      );
    } else {
      return result;
    }
  ...
  if (!objectOrPairs || objectOrPairs instanceof Array) {
    if (objectOrPairs) {
      for (var index = 0; index < objectOrPairs.length; index++) {
        ...
        var val = pair[1];
        if (
          !(objectOrPairs instanceof Array) &&
          objectOrPairs instanceof Object
        ) {
...
export function __getitem__(container, key) {
  if (typeof container == "object" && "__getitem__" in container) {
    ...
    (typeof container == "string" || container instanceof Array) &&
    key < 0
  ) {
...
export var __sort__ = function (iterable, key, reverse) {
  ...
  if (
    ...
    (reverse != null && reverse.hasOwnProperty("__kwargtrans__"))
  ) {
    var reverse = false;
  }
  if (arguments.length) {
...
export var __Terminal__ = __class__("__Terminal__", [object], {
  ...
  get print() {
    return __get__(this, function (self) {
      ...
      if (self.element) {
        self.element.innerHTML = self.buffer
          .py_replace("\n", "<br>")
          .py_replace(" ", "&nbsp");
